...
import { sectionFormSchema, SectionFormData } from "../schemas/sections.schema";
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 space-y-6">
          <Card className="p-6 rounded-[24px] border border-divider shadow-none">
            <h3 className="text-lg font-semibold text-content-primary mb-4">{t("section_image")}</h3>
            
            <FormItem className="space-y-1">
              <FormLabel className="text-content-secondary text-base">{t("section_image")}</FormLabel>
          ...
          <Card className="p-8 rounded-[32px] border border-divider shadow-none">
            ...
            <div className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-base text-content-secondary">{t("section_description_ar")}</FormLabel>
                    <FormControl>
                      <Textarea
                        {...field}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-base text-content-secondary">{t("section_description_en")}</FormLabel>
                    <FormControl>
                      <Textarea
                        {...field}
